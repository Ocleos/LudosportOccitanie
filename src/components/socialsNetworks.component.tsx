  ...
  return (
    <div>
      ...
      <div className='m-auto flex w-full flex-row justify-center gap-8 p-4'>
        <a href='https://www.facebook.com/ludosportoccitanie/' rel='noreferrer' target='_blank'>
          <img alt='Facebook' className='h-12 w-12' src={Facebook} />
        </a>

        <a href='https://www.instagram.com/ludosport.occitanie/' rel='noreferrer' target='_blank'>
          <img alt='Instagram' className='h-12 w-12' src={Instagram} />
        </a>
      </div>
    </div>
  );
